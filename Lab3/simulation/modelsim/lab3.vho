...
-- S[0]	=>  Location: PIN_AE12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- S[3]	=>  Location: PIN_AD12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- Cout	=>  Location: PIN_AF13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- Overflow	=>  Location: PIN_AE13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \Add0~0_combout\ = \Y~combout\(0) $ (\Cin~combout\)
...
-- Equation(s):
-- \Add0~5_combout\ = \Cin~combout\ $ (\Y~combout\(1))
...
-- Equation(s):
-- \Add0~8_combout\ = \Cin~combout\ $ (\Y~combout\(2))
...
-- Equation(s):
-- \Add0~11_combout\ = \Y~combout\(3) $ (\Cin~combout\)
...
-- Equation(s):
-- \Add0~14_combout\ = \Cin~combout\ $ (\Add0~13\)
...
-- Equation(s):
-- \Overflow~0_combout\ = \X~combout\(3) $ (\Y~combout\(3) $ (\Add0~12_combout\ $ (\Add0~14_combout\)))
